...
- `reviewThreads(first: 100)` and count `isResolved == false` directly.
...
- If the user reports contradictory UI, trust the screen and re-query immediately with `first: 100`.
